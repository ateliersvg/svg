 ...
 *
 * @see https://www.w3.org/TR/SVG11/shapes.html#PolygonElement
 */
final class PolygonElement extends AbstractContainerElement
{
     ...
     *
     * @param string $points The points attribute (e.g., "0,0 100,0 100,100 0,100")
     */
    ...
    /**
     * Gets the points that define the polygon.
     *

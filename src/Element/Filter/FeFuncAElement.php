...
/**
 * Represents the <feFuncA> SVG filter primitive component.
 *
 * Defines the transfer function for the alpha component of the input graphic.
 * Must be a child of feComponentTransfer.
 *
 * @see https://www.w3.org/TR/SVG2/filters.html#feFuncAElement
 */
final class FeFuncAElement extends AbstractElement
{
    public function __construct()
    {
        parent::__construct('feFuncA');
    }

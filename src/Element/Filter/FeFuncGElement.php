...
/**
 * Represents the <feFuncG> SVG filter primitive component.
 *
 * Defines the transfer function for the green component of the input graphic.
 * Must be a child of feComponentTransfer.
 *
 * @see https://www.w3.org/TR/SVG2/filters.html#feFuncGElement
 */
final class FeFuncGElement extends AbstractElement
{
    public function __construct()
    {
        parent::__construct('feFuncG');
    }

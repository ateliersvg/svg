...
/**
 * Represents the <feFuncB> SVG filter primitive component.
 *
 * Defines the transfer function for the blue component of the input graphic.
 * Must be a child of feComponentTransfer.
 *
 * @see https://www.w3.org/TR/SVG2/filters.html#feFuncBElement
 */
final class FeFuncBElement extends AbstractElement
{
    public function __construct()
    {
        parent::__construct('feFuncB');
    }

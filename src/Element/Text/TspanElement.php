 ...
 *
 * The tspan element is used within a text element or another tspan element to
 * provide additional text styling or positioning for a substring of text.
 * It can contain nested tspan elements.
 *
 * @see https://www.w3.org/TR/SVG11/text.html#TSpanElement
 */
final class TspanElement extends AbstractContainerElement
{
    ...
    /**
     * Sets the position of the tspan using x and y coordinates.
     *
     * @param string|int|float $x The x coordinate
     * @param string|int|float $y The y coordinate
     */
